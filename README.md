...
See [Services and Request Flow](SERVICES_AND_REQUEST_FLOW.md) for the repository
map, startup commands, implemented endpoints, current anonymous visitor flow,
and planned ingestion/RAG sequence.
